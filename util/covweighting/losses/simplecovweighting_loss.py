...
class SimpleCoVWeightingLoss(SimpleBaseLoss):

    """
        Wrapper of the SimpleBaseLoss which weighs the losses to the Cov-Weighting method,
        where the statistics are maintained through Welford's algorithm. But now for 32 losses.
    """

    def __init__(self, args):
        super(SimpleCoVWeightingLoss, self).__init__(args)
